...
Page<IData, WechatMiniprogram.IAnyObject>({
  data: {
    ...
    删的: [
      ...
      '问过的签、屋里说过的话',
      '村里住着的人',
      /* 这两条 2026-09-07 并成一行 —— 「一条一条说出来」说的是
         每一样东西都要指名，不是每一样都要单占一行。并了之后
         这一屏才放得下底下那条「钱会停」，而那一条比多一行留白重要。 */
      '得到的徽章、点过的香、报过名的场次',
    ],
    留的: [
      '买过的单子与付款记录（法律要求）',
    ...
    /* 【钱那一头也要说】（2026-09-07 · 文案对行为那一支门禁抓到的第一条）。
       ...
       【它归「之后」，不另开一块】。第一版给了它自己一块，
       这一屏当场超出一屏 54px（`check-fold` 抓到）——
       而「注销之后会怎样」问的正是这件事，本来就该在那儿。
       「已扣的那一期不退」不写在这儿:停订那一屏与协议各说过一遍，
       同一句话摆到第三处，只是多两个会各自漂的地方。 */
    之后的: [
      '订着的按月送会停掉，不再扣钱',
      '这个号再也进不来 —— 微信也认不回它',
      '再打开就是一个新的人，村子是空的',
