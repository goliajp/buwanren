...
const 底线 = 0.80
/* 【豁免撤了】。丹增原先只露 65%，写着「盘坐在蒲团里，下半身本就该陷进去」
   —— 而真正的原因是他坐在坛城的暗红回纹上，跟僧袍同色，进屋第一眼
   找不到人（2026-09-01 五路评审 · 视觉）。把开局位置挪到坛城中间那片
   蓝底上之后，露出 85%，六间房都在同一条线上。
   降底线是最容易的一步，也是最容易把问题盖住的一步 —— 这一次证明了
   该改的是那间房，不是这条线。 */
const 豁免 = {}
const 口 = 6098
