...
....KnK...`)
  ...
  const RULES = [
    ...
    { s:'ayun', t:'noon', x:'clear', p:'plaza', cd:150, l:'正午的广场太晒了，我要化了' },
    ...
    { s:'ayun', x:'rain', p:'market', cd:90, l:'伞？我算到了，但没带' },
    ...
    { s:'tao', t:'night', p:'plaza', cd:90, l:'夜里摆盘最准，你不懂' },
    ...
    /* 【上面那段鉴定是错的，已作废】（2026-09-02 复核）。
       我曾在这里断言「量过了，不改」——两处都错:
       · **语料错**。我量的是这个文件里的 255 条 bark，
         而评审说的是 `villager_line`（村主屏那句「今天说」，160 行）。
       · **句式错**。我按「恰好一个逗号」去数，得四成；
         而那批台词真正的形状是「短陈述。展开」——
         `^[^。？！]{2,12}。[^。]+$` 实测 **107/160 = 66.9%**，
         另有 110 条以一个两到十二字的短句加句号开头。
       评审说的 113/160 是对的。这条**成立**，且它落在
       村主屏字号最大的那一句上。台词改写另记。
       教训跟这个仓里反复出现的那条一样:量错语料的结论，
       跟没量一样，只是它看起来像量过了。 */
  ...
  const CONVOS = [
    { a:'tao', b:'ayun', L:[['a','喂，道士，别走路睡觉'],['b','……唔？哦，桃桃啊'],['a','哼，眼睛都睁不开'],['b','我这叫闭目养神']] },
    ...
    { a:'tao', b:'ayun', p:'market', cd:240, L:[['a','早市的桃子被我包了'],['b','我只想买两个'],['a','……给你一个'],['b','……谢了']] },
    { a:'popo', b:'ayun', L:[['a','小道士，气色不太好哦'],['b','昨晚熬夜了'],['a','来，吃颗糖'],['b','谢婆婆']] },
    { a:'popo', b:'ayun', L:[['a','年轻人要早睡'],['b','我在参悟'],['a','参悟什么'],['b','……排位赛的机制']] },
    { a:'popo', b:'ayun', p:'plaza', cd:240, L:[['a','这单子接不完，帮我算算？'],['b','按小时算钱'],['a','管饭'],['b','成交']] },
    { a:'popo', b:'ayun', x:'rain', cd:240, L:[['a','雨天关节疼哦'],['b','婆婆，我帮你把窗关上'],['a','乖孩子～']] },
    { a:'tenz', b:'ayun', L:[['a','小道士，一起练？'],['b','……我更适合静功'],['a','躺着不算静功'],['b','躺着最静']] },
    { a:'tenz', b:'ayun', t:'dusk', cd:240, L:[['a','今晚有法会，来听鼓'],['b','几点结束'],['a','天亮'],['b','那我正好打完游戏来']] },
    ...
    { a:'popo', b:'tao', p:'plaza', cd:240, L:[['a','塔罗和摆盘，你更信哪个'],['b','当然是摆盘'],['a','那你翻一张试试'],['b','……为什么是塔？']] },
    ...
    { a:'villm', b:'ayun', L:[['a','小道士，帮我看看今天出门顺不顺'],['b','（掐指）……顺'],['a','这么快？'],['b','我快，但准']] },
    ...
    { a:'vfruit', b:'ayun', p:'market', cd:240, L:[['a','小道士，来点果子？'],['b','我……身上没带钱'],['a','（叹气）先拿去吧']] },
  ]
