(function(){
  ...
  var ROOM = globalThis.AYUN_ROOM = {
    ...
    /* 按钮上不写行话。「起一课」「排个盘」「测个字」「指点迷津」这些是
       ...
       【2026-09-01】动作还要跟这个人的术对得上。上一轮换动作时对错了人:
       婆婆的术是塔罗、却写成「看水晶球」;桃桃是奇门遁甲、却写成「翻张牌」——
       翻牌是塔罗的动作，两个人的活儿串了，三路评审各自独立抓到。
       现在:阿云掐指算（大六壬）／白鹭看星（紫微）／婆婆翻牌（塔罗）／
       沈砚拆字（梅花）／桃桃摆盘（奇门）／丹增拨念珠（藏历）。
       scripts/check-cast-act.py 从此盯着这一条。 */
      button: 'ayunCastBtn', labels: ['请阿云掐指算算', '收了'], stateKey: 'casting',
      lineGap: 5200,
      /* 【他是个睡不醒的小道士，不是讲台上的人】（2026-09-02 第二轮评审 · 文案）。
         这十二句里有五句是术语堂课:四课、三传、初传/中传/末传、课怎么起。
         而这一版明写着「完全不允许有任何文言古书的表达，
         只能在命理分析的专业细节里有」—— 屋里的话不是分析，是他在说话。
         他别处的口气是「唔」「有意思」「乖」「就打一把……就一把」。

         意思一个不丢，只是换成他会说的话:「四课」本来就是【事情的四个面】
         （第十句一直是这么说的，那句是对的，其余五句照它改），
         「三传」就是起头 → 当中 → 落下。
         留着的那几句本来就没有术语。 */
      lines: ['这一刻你不掐住它  它就掐住你', '四个面摆齐了  事情才有骨架',
              '起头是因  当中是变  落下是果', '摆出来的是死的  人是活的',
              '今天走到哪儿  就从哪儿起手', '一面看你  一面看他  剩下两面看你们怎么缠',
              '推到这一步  往后它自己会走', '看得清  未必躲得开',
