  ...
  def("shenyan_desk_zi", {
    ...
    draw(g) {
      ...
      if (globalThis.CALLI) globalThis.CALLI(g, '时', 218, 180, 40, '#2b2318', { weight: 1.3 })
    ...
    fx(g, t, x, y, o, room) {
      ...
      if (globalThis.CALLI) {
        ...
        globalThis.CALLI(g, '運', 216, 178, 42, '#241d14', { weight: 1.35 })
        g.restore()
      }
  ...
  def("shenyan_screen_draw", {
    ...
    /* ★ 全屋唯一主动发光的东西 —— 一个读书人的屋子里,亮着的是彩票。
       【2026-09-03 第四轮评审把它报成「时代混搭」，不改】。
       评审读到的是「中式书生的和室里放着现代显示器」——
       而这个产品的世界本来就是现代与传统并置的:婆婆在线接单、
       有二维码立牌，阿云熬夜打排位。沈砚守着开奖屏，
       正是他「缺运」的样子，也是这间房唯一的立意。
       混搭是设定，不是疏漏。 */
